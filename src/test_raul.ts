...
export class Marshall {
    ...
    public compare2JSONpath(before: any, after: any): Tupla[] {
        ...
        tuplas3 = this.checkbefaft(before, after, "", []);
        tuplas3 = this.checkaftbef(before, after, "", tuplas3);
...
jsonld.compact(doc, context, function (err: any, compacted: any) {
    ...
    const marshalled3 = marshall.marshall(example24, "", []);

    console.log(marshalled3);

    const resultObj = marshall.unMarshall(marshalled3);
